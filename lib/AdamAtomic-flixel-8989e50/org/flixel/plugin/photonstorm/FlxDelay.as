...
package org.flixel.plugin.photonstorm 
{
	...
	public class FlxDelay extends Sprite
	{
		 ...
		 */
		public function FlxDelay(runFor:int, callback:Function=null)
		{
			duration = runFor;
		 ...
		 */
		public function get msElapsed():int
		{
			return isRunning ? (getTimer() - started) : (complete ? duration : 0);
		}
		
		/**
		 * The amount of milliseconds that are remaining until the timer completes
		 */
		public function get msRemaining():int
		{
			return isRunning ? (expires - getTimer()) : (complete ? 0 : duration);
		}
